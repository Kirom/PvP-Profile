# PvP Profile v1.0.5 Release Notes
...
- **What Changed**: Updated the addon's interface version from 110200 to 110205
- **Why**: This ensures compatibility with the latest World of Warcraft patch
- **Technical Details**:
  - Updated `PvPProfile.toc` to use interface version 110205
